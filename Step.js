...
router.get('/get/html', function(req, res) {
    ...
    var xml = fs.readFileSync('Step.xml', 'utf8'); //We are reading in the XML file
    var xsl = fs.readFileSync('Step.xsl', 'utf8'); //We are reading in the XSL file
...
router.post('/post/json', function(req, res) {
  ...
  function appendJSON(obj) {
    ...
    xmlFileToJs('Step.xml', function(err, result) {
      if (err) throw (err);
      ...
      result.danceclasses.section[obj.sec_n].entree.push({'level': obj.level, 'price': obj.price}); //If your XML elements are differet, this is where you have to change to your own element names
      //Converting back to our original XML file from JSON
      jsToXmlFile('Step.xml', result, function(err) {
...
router.post('/post/delete', function(req, res) {
  ...
  function deleteJSON(obj) {
    ...
    xmlFileToJs('Step.xml', function(err, result) {
      ...
      delete result.danceclasses.section[obj.section].entree[obj.entree];
